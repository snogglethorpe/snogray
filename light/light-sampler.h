// light-sampler.h -- Sampling interface for lights
//
...
#ifndef SNOGRAY_LIGHT_SAMPLER_H
#define SNOGRAY_LIGHT_SAMPLER_H
...
// An interface for sampling a Light, which is used for lighting
// calculations.
//
class Light::Sampler
{

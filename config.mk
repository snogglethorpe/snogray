...
#
#  Copyright (C) 2005-2014  Miles Bader <miles@gnu.org>
#
...
# CXX_CHECK_FLAGS, CXX_THREAD_FLAGS, and EXTRA_COMPILE_FLAGS are set
# by configure.
#
...
#
AM_CFLAGS = $(OPT) $(DEBUG) $(CXX_THREAD_FLAGS) $(CXX_CHECK_FLAGS) $(EXTRA_COMPILE_FLAGS)
AM_CXXFLAGS = $(OPT) $(DEBUG) $(CXX_STD_FLAGS) $(CXX_THREAD_FLAGS) $(CXX_CHECK_FLAGS) $(EXTRA_COMPILE_FLAGS)

# Versions of AM_CFLAGS and AM_CXXFLAGS for situations where we want to
# optimize for size.
#
AM_CFLAGS_SIZE = $(OPT_SIZE) $(DEBUG) $(CXX_THREAD_FLAGS) $(EXTRA_COMPILE_FLAGS)
AM_CXXFLAGS_SIZE = $(OPT_SIZE) $(DEBUG) $(CXX_STD_FLAGS) $(CXX_THREAD_FLAGS) $(CXX_CHECK_FLAGS) $(EXTRA_COMPILE_FLAGS)

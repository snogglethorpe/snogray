...
SNOGRAY_SRCS = brdf.cc camera.cc cubetex.cc far-light.cc freelist.cc	\
	  glass.cc glow.cc intersect.cc lambert.cc light.cc material.cc	\
	  mesh.cc mirror.cc surface.cc phong.cc point-light.cc		\
	  primary-surface.cc ray.cc rect-light.cc texture2.cc scene.cc	\
	  scene-load.cc scene-load-aff.cc snogray.cc space.cc sphere.cc	\

...
SCENE_LIBS =	$(LIB3DS_LIBS)

LIBS =		$(IMAGE_LIBS) $(SCENE_LIBS) $(MUDFLAP:-f%=-l%)
...
RENDER_SRCS = brdf.cc camera.cc cook-torrance.cc cubetex.cc far-light.cc \
	  ...
	  load-3ds.cc lsamples.cc material.cc mesh.cc mesh-load.cc	 \
	  mirror.cc surface.cc phong.cc plastic.cc point-light.cc	 \
